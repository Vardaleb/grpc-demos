...
const (
	Greeter_Greet_FullMethodName = "/hello.Greeter/greet"
)
...
func (c *greeterClient) Greet(ctx context.Context, in *Greeting, opts ...grpc.CallOption) (*Greeting, error) {
	out := new(Greeting)
...
func (UnimplementedGreeterServer) Greet(context.Context, *Greeting) (*Greeting, error) {
